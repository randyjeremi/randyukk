...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark" style="" >
        <div class="container">
            <a class="btn btn-danger" href="pendataan.php">Kembali</a>
    ...
    <div class="container mt-5">
        <h1 style="font-family: Bungee; color: orange;">Daftar Pengguna</h1>
        <div class="card" style="background-image: url(assets/bgutama.jpg); background-size: cover;">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
