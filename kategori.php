...
<body>
    <h1 class="mt-4" style='margin-left: 2rem; font-family: Bungee; color: orange;'>Kategori Buku</h1>
    <div class="card" style='margin-left: 2rem;  margin-right: 2rem; background-image: url(assets/bgutama.jpg); background-size: cover;'>
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <a href="kategori_tambah.php" class="btn btn-primary" style='margin-bottom: 2rem;'>+ Tambah Data</a>
